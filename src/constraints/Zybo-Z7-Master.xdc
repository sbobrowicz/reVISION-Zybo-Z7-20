...
set_false_path -from [get_clocks clk_out1_*_clk_wiz_0_*] -to [get_clocks clk_fpga_0]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks clk_out1_*_clk_wiz_0_*]
