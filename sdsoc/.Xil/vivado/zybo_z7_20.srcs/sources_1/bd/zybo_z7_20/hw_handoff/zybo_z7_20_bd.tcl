...
################################################################
# This is a generated script based on design: zybo_z7_20
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./git/Zybo-Z7-20-base-sdsoc/src/bd
...
CONFIG.CLK_DOMAIN {zybo_z7_20_sys_clock} \
...
CONFIG.CLKOUT3_JITTER {93.189} \
CONFIG.CLKOUT3_PHASE_ERROR {73.940} \
CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {115} \
...
CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {76.190483} \
...
CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR0 {14} \
...
CONFIG.kRstActiveHigh {false} \
  ...
  # Create instance: rst_clkwiz0_clk2, and set properties
  set rst_clkwiz0_clk2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clkwiz0_clk2 ]

  # Create instance: rst_clkwiz0_clk3, and set properties
  set rst_clkwiz0_clk3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clkwiz0_clk3 ]
  ...
  # Create instance: rst_ps7_fclk3, and set properties
  set rst_ps7_fclk3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_fclk3 ]
...
CONFIG.NUM_PORTS {6} \
  ...
  connect_bd_intf_net -intf_net TMDS_1 [get_bd_intf_ports hdmi_in] [get_bd_intf_pins dvi2rgb_1/TMDS]
  ...
  connect_bd_net -net clk_in1_1 [get_bd_ports sysclk] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins rst_clkwiz0_clk2/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins rst_clkwiz0_clk3/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clkwiz0_clk2/dcm_locked] [get_bd_pins rst_clkwiz0_clk3/dcm_locked]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK4 [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins rst_ps7_fclk3/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clkwiz0_clk2/ext_reset_in] [get_bd_pins rst_clkwiz0_clk3/ext_reset_in] [get_bd_pins rst_ps7_fclk0/ext_reset_in] [get_bd_pins rst_ps7_fclk1/ext_reset_in] [get_bd_pins rst_ps7_fclk3/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph_GP0/ARESETN] [get_bd_pins rst_ps7_fclk0/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_sw_btn/s_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_i2s_adi_0/DMA_REQ_RX_RSTN] [get_bd_pins axi_i2s_adi_0/DMA_REQ_TX_RSTN] [get_bd_pins axi_i2s_adi_0/S_AXI_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins dvi2rgb_1/aRst_n] [get_bd_pins ps7_0_axi_periph_GP0/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M02_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M03_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M04_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M05_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M06_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M07_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M08_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M09_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M10_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/S00_ARESETN] [get_bd_pins pwm_rgb/pwm_axi_aresetn] [get_bd_pins rst_ps7_fclk0/peripheral_aresetn] [get_bd_pins v_tc_in/s_axi_aresetn] [get_bd_pins v_tc_out/s_axi_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net rst_ps7_0_133M_interconnect_aresetn [get_bd_pins axi_mem_intercon_HP0/ARESETN] [get_bd_pins rst_ps7_fclk1/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_133M_peripheral_aresetn [get_bd_pins axi_mem_intercon_HP0/M00_ARESETN] [get_bd_pins axi_mem_intercon_HP0/S00_ARESETN] [get_bd_pins axi_mem_intercon_HP0/S01_ARESETN] [get_bd_pins rst_ps7_fclk1/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_ports ac_muten] [get_bd_pins xlconstant_high/dout]
